...
export const SideBar = () => {
  return (
    <>
        ...
        >
          <Flex justifyContent={'space-between'} flexDirection={'column-reverse'}>
          <Box mt={8} cursor={"pointer"}>
            <Link href={'https://www.linkedin.com/in/akshat-gaur-2b1973217/'}>
            <img src="/static/linkedin.png" alt="" />
            </Link>
          </Box>
          <Box mt={8} cursor="pointer">
            <Link href={'https://github.com/jueviole-grace/'} >
            <img src="/static/github.png" alt="" />
            </Link>
          </Box>
          <Box mt={8} cursor={"pointer"}>
            <Link href={'https://leetcode.com/jueviole-grace/'}>
