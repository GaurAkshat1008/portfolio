          ...
          >
            ...
            >
              ...
              <Text>
                ...
                beautiful, responsive websites. I have a background in business
                and a passion for learning new technologies.
              </Text>
              <Text>
                I'm a self-taught developer and I'm currently working on my own
                projects. The tech stack that I use include a variety of
                frameworks including{" "}
                <Code colorScheme={"whatsapp"}>express.js</Code>,{" "}
                <Code colorScheme={"whatsapp"}>react.js</Code>,{" "}
                <Code colorScheme={"whatsapp"}>next.js</Code>, and a wide range
                of APIs and middleware
              </Text>
              {/* </VStack> */}
            </VStack>
          </Flex>
